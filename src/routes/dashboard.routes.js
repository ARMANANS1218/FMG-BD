...
/**
 * @route   GET /api/v1/dashboard/management/summary
 * @access  Private (Management, Admin)
 * @desc    Get lightweight management dashboard summary
 */
router.get('/management/summary', validateToken, dashboardController.getManagementDashboardSummary);
