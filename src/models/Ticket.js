...
const forwardSchema = new mongoose.Schema({
  ...
  toAgent: { type: mongoose.Schema.Types.ObjectId, ref: "User" }, // Can be null if forwarded to a role/queue without specific agent?
  reason: { type: String }, // Reason for escalation/forwarding
