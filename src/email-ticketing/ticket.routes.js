...
// Remark route
router.post('/tickets/:id/remark', authenticateToken, ctrl.addRemark);

// Escalation / Transfer routes
router.post('/tickets/:ticketId/transfer', authenticateToken, ctrl.transferTicket);
router.post('/tickets/:ticketId/transfer/accept', authenticateToken, ctrl.acceptTransferRequest);
router.get('/tickets/:ticketId/escalation-chain', authenticateToken, ctrl.getEscalationChain);
