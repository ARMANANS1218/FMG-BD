...
const TicketSchema = new mongoose.Schema(
  {
    ...
    resolutionType: {
      type: String,
      enum: ['Refund', 'Replacement', 'Voucher', 'Information Provided', 'Escalated', null],
      default: null,
    },
    refundAmountGbp: { type: Number, default: 0, min: 0 },
    compensationType: { type: String, default: null, trim: true },
    courierRequired: { type: Boolean, default: false },
    returnLabelSent: { type: Boolean, default: false },
    refundApprovalAuthorizationId: { type: String, default: null, trim: true },
    tlApprovalRequired: { type: Boolean, default: false },
    tlApproval: { type: Boolean, default: null },
    tlApprovedBy: { type: mongoose.Schema.Types.ObjectId, ref: 'User', default: null },
    tlApprovedAt: { type: Date, default: null },
    workflowUpdatedAt: { type: Date, default: null },
